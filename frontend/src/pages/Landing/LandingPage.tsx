...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 font-sans selection:bg-emerald-500 selection:text-white">
      ...
      <div className="relative min-h-screen flex flex-col justify-between overflow-hidden bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: `url('/hero_bg.png')` }}
      >
        {/* Subtle Ambient Vignette / Lighting Gradient Layer */}
        <div className="absolute inset-0 bg-gradient-to-b from-white/35 via-transparent to-black/60 pointer-events-none" />

        {/* ─── TOP GLASS FLOATING NAVBAR (EXACT REFERENCE DESIGN) ─────────────── */}
        <header className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          >
            {/* 4-Quadrant Shield Emblem */}
            <div className="w-11 h-11 rounded-xl bg-white/95 border border-emerald-600/30 p-1.5 shadow-md flex flex-wrap items-center justify-center gap-0.5 shrink-0 backdrop-blur-md">
          ...
          {/* Navigation Links */}
          <nav className="hidden md:flex items-center gap-7 bg-white/40 backdrop-blur-md px-6 py-2 rounded-full border border-white/60 shadow-xs text-sm font-semibold text-slate-800">
            {[
          ...
          <div className="flex items-center gap-2.5">
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 bg-white/80 hover:bg-white text-emerald-900 rounded-full text-xs font-extrabold border border-emerald-600/30 shadow-xs backdrop-blur-md transition-all hover:scale-105"
            >
            ...
            {user ? (
              <button
                ...
                className="px-4 py-2 bg-[#0f2c59] hover:bg-[#0c2340] text-white rounded-full text-xs font-bold shadow-md transition-all hover:scale-105"
              >
                My Account
              </button>
            ) : (
              <button
                ...
                className="px-4 py-2 bg-[#0f2c59] hover:bg-[#0c2340] text-white rounded-full text-xs font-bold shadow-md transition-all hover:scale-105 flex items-center gap-1.5"
              >
        ...
        {/* ─── HERO MAIN CONTENT (LEFT ALIGNED PER REFERENCE IMAGE) ──────────── */}
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12">
          <div className="max-w-2xl space-y-4">
            <motion.h1
              ...
              className="text-4xl sm:text-5xl lg:text-6xl font-black text-[#0c2340] tracking-tight leading-[1.1]"
            >
              Building a <br />
            ...
            <motion.div
              ...
              className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[#157948] tracking-tight leading-snug"
            >
            ...
            <motion.p
              ...
              className="text-sm sm:text-base font-semibold text-slate-800/90 leading-relaxed max-w-xl pt-2"
            >
            ...
            >
              ...
              <button
                ...
                className="bg-white/85 hover:bg-white text-slate-900 border border-slate-300/80 px-6 py-3.5 rounded-full font-extrabold text-sm shadow-lg hover:scale-105 transition-all flex items-center gap-2 backdrop-blur-md"
              >
        ...
        {/* ─── BOTTOM 6 FROSTED GLASS FEATURE CARDS (EXACT MATCH) ─────────────── */}
            ...
            {bottomFeatureCards.map((card, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-emerald-950/45 hover:bg-emerald-950/75 border border-emerald-400/35 hover:border-emerald-300/70 backdrop-blur-md rounded-2xl p-3.5 transition-all duration-300 hover:-translate-y-1.5 text-white shadow-2xl cursor-pointer flex flex-col justify-between space-y-2 group"
                >
                  <div className="space-y-1.5">
                    <div className="w-8 h-8 rounded-xl bg-emerald-500/25 border border-emerald-300/30 flex items-center justify-center text-emerald-300 group-hover:scale-110 transition-transform">
      ...
      {/* ─── DETAILED CIVIC SERVICES DIRECTORY SECTION ──────────────────────── */}
      <section id="services-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-10">
          ...
          {civicServices.map((service) => {
            ...
            return (
              <motion.div
                whileHover={{ y: -3 }}
                key={service.name}
                className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs hover:shadow-md transition-all cursor-pointer flex flex-col justify-between space-y-3"
