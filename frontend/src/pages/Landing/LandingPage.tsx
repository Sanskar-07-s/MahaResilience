          ...
          <div className="space-y-4 text-xs">
            <div className="space-y-1">
              ...
              <p className="text-slate-500 text-xs leading-relaxed">
                Yes! The platform is designed offline-first. Critical datasets like hospital directories, shelter shelters, first-aid manuals, and public schemes are cached in browser IndexedDB storage and remain usable offline.
              </p>
            </div>
            <div className="space-y-1">
